...
public class Ticket extends BaseEntity {
    ...
    public void   setTicketNumber(String n)      { this.ticketNumber = n; }
    ...
    public void   setFareClassId(Long fareId)    { this.fareClassId = fareId; }
    ...
    public String toString() {
        return "Ticket{" + ticketNumber + " · booking=" + bookingId + " · flight=" + flightId + "}";
    }
}
